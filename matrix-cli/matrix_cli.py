...
class MatrixAdmin:
    ...
    def park_alias(self, alias, parking_room_id='!GrRRLYVADFUBjqnEwX:matrix.org'):
        access_token = self._client.token
    ...
    def assign_alias(self, room_id, alias):
        access_token = self._client.token
    ...
    def shutdown_room_and_quarantine_media(self, room_id,
                                           message=None,
                                           new_room_name='Room unavailable'):
        if message is None:
